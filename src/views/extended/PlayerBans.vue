<template>
  <div class="card">
    <div class="flex items-center gap-2 mb-6">
      ...
      <div class="font-semibold text-xl">Блокировка игроков</div>
    </div>

    <div class="text-muted-color mb-6">
      Создание заявки на вечную блокировку игрока
    </div>

    <Message severity="warn" :closable="false" class="mb-6">
      <strong>Внимание:</strong> Вечная блокировка - необратимое действие, требующее подтверждения администратором Level 7+
    </Message>

    <div class="grid grid-cols-12 gap-6">
      <div class="col-span-12 md:col-span-6">
        <label class="block text-sm font-medium mb-2">
          Никнейм игрока <span class="text-red-500">*</span>
        </label>
        <InputText
      ...
      <div class="col-span-12 md:col-span-6">
        ...
        <div class="p-3 surface-ground border-round">
          <div class="flex align-items-center gap-2">
            ...
            <span class="font-semibold">Вечная блокировка</span>
          </div>
        </div>
      </div>
      ...
      <div class="col-span-12">
        ...
        <Textarea
          ...
          rows="5"
          placeholder="Опишите причину блокировки игрока"
          maxlength="1000"
          :autoResize="true"
        />
...
const validateForm = () => {
  ...
  if (!formData.value.target_admin_name.trim()) {
    errors.value.target_admin_name = 'Укажите никнейм игрока';
    isValid = false;
  }
